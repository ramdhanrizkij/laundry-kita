<div>
        <div wire:show="openDeleteModal" x-cloak>
            <!-- Modal background -->
            <div class="fixed inset-0 bg-black/50 flex items-start justify-center z-[80]">
                ...
                <div class="bg-white rounded-lg shadow-lg max-w-xl w-full mt-16">
                    ...
                    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold">Konfirmasi Hapus Service</h3>
                        <button type="button"
                    ...
                    <div class="px-6 py-4 text-sm text-gray-700">
                        <p>Apakah anda yakin akan menghapus data service <b>{{ $service?->name }}</b> ?</p>
                    </div>
