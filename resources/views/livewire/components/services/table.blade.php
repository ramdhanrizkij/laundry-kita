<div>
                            ...
                            @foreach ($services as $item)
                                <tr>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block text-sm text-gray-500 dark:text-neutral-500">{{ $item->description }}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
    ...
    @livewire('components.services.modalform')
    @livewire('components.services.delete-modal')
</div>
